    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-end pt-2 my-2 border-top">
        <div class="col-12 col-md-8 d-flex align-items-center">
                <span class="mb-3 mb-md-0 text-body-secondary">
                    <?= App::$config['name'] ?> v<?= App::$config['version'] ?> © <?= date('Y') ?> JC IT NETWORK, LLC
                    <br>
                    <?= App::t('This software is licensed under the {link}.', ['<a href="https://github.com/Jcarrasco96/tinyexplorer/blob/master/LICENSE.md" target="_blank">AGPL-3.0</a>']) ?> <?= App::t('Source code is available {link}.', ['<a href="https://github.com/Jcarrasco96/tinyexplorer" target="_blank">' . App::t('here') . '</a>']) ?>
                </span>
        </div>
        <ul class="col-12 col-md-4 d-flex flex-column justify-content-end align-items-end list-unstyled mb-0">
            ...
            <li class="ms-2"><a class="report-bug" href="https://github.com/Jcarrasco96/tinyexplorer/issues" target="_blank"><i class="bi bi-bug"></i> <?= App::t('Report issue') ?></a></li>
        </ul>
    </footer>
</div>
